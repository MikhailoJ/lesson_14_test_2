...
function ageClassification(n) {
  var num = '';
  num = n < 0 ? 'null' : n < 24  ? 'детский возраст' : 'молодой возраст' , n > 24 ? 'молодой возраст' : n < 44 ? 'молодой возраст' : 'средний возраст',
  n > 44 ? 'средний возраст' : n < 65 ? 'средний возраст' : 'средний возраст';  
  return num;
}
